...
class ReceiptsControllerTest < ActionController::TestCase
  ...
  test "should create receipt" do
    assert_difference('Receipt.count') do
      post :create, receipt: { (details: @receipt.(details, : @receipt., : @receipt., image: @receipt.image }
    end
  ...
  test "should update receipt" do
    patch :update, id: @receipt, receipt: { (details: @receipt.(details, : @receipt., : @receipt., image: @receipt.image }
    assert_redirected_to receipt_path(assigns(:receipt))
  end
